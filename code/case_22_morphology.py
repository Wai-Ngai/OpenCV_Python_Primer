...
开操作:先腐蚀再膨胀。它被用来去除噪声，消除图像中小的干扰区域。还可以尽量保留了其他的元素没有变化
闭操作:先膨胀再腐蚀。它经常被用来填充前景物体中的小洞，或者前景物体上的小黑点。还可以尽量保留了其他的元素没有变化

其他形态学操作：

顶帽：原图像与开操作之间的差值图像  tophat
黑帽：闭操作与原图像直接的差值图像  blackhat
